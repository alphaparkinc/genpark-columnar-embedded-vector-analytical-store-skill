# genpark-columnar-embedded-vector-analytical-store-skill
...
> **GenPark AI Agent Skill** -- Columnar embedded vector analytical store with predicate pushdown (Chroma DuckDB style)
